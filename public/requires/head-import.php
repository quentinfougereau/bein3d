...
?>
    <title>BE in 3D</title>
        ...
        <script type="text/javascript" src="<?php echo $chemin; ?>public/js/Ajax.js"></script>
        ...
        src="<?php echo $chemin; ?>public/components/webcomponentsjs/webcomponents.js"></script>
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/core-toolbar/core-toolbar.html">
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/core-drawer-panel/core-drawer-panel.html">
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/core-header-panel/core-header-panel.html">
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/core-item/core-item.html">
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/core-icon/core-icon.html">
        <link rel="import"
        ...
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/paper-icon-button/paper-icon-button.html">
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/paper-menu-button/paper-menu-button.html">
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/paper-item/paper-item.html">
        <link rel="import"
        ...
        <link rel="import"
              href="<?php echo $chemin; ?>public/components/paper-button/paper-button.html">
        <link rel="import"
        ...
        <link rel="stylesheet" href="<?php echo $chemin; ?>/public/style/shadow-dom.css" type="text/css">
        <!-- FONTS -->
